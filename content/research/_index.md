...
<div class="paper">
<span class="title">Invention and the Life Course: Age Differences in Patenting</span> (with Adam B. Jaffe & Margie Lachman)<br>
<span class="meta"><em>Research Policy</em>, 52(1), 104629 · 2023 · <a href="https://www.nber.org/papers/w28768">NBER WP w28768</a> · <a href="https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/YRLSKU">Dataset</a></span>
...
<span class="meta">Under review, <em>Structural Change and Economic Dynamics</em> · 2025</span>
<details><summary>Abstract</summary>
...
<div class="paper">
<span class="title">The Impact of Draft Position and Early Career Performance on NFL Long-Term Success</span> (with McKenna Moore)<br>
<span class="meta">2025</span>
<details><summary>Abstract</summary>
<p class="abstract"> The reverse order system of the NFL (draft) is structured to provide teams that performed poorly in the prior season to have a higher likelihood of restructuring their team and bring competitive balance to the NFL. Teams observe college players to scout and recruit potential incoming draft picks and thus, prior performance of college players are signals to NFL recruiters. However, college success may not always be the best predictor of NFL individual player success. We explore if being a first-round pick compared to other rounds can accurately predict individual success in the professional league.  Using propensity score matching to best compare first round players vs. other players with their college statistics, we estimate the likelihood of first round draft picks succeeding in the NFL and if they achieve success faster. We find that while being drafted in round 1 does not improve increase the chance of overall professional success, if a candidate is successful and they are drafted in round 1 the time in which it takes them to succeed is slightly shorter than a candidate drafted in subsequent. 
</p>
</details>
</div>
...
<div class="paper">
<span class="title">Disrupting the Water Cooler: The Impact of Location on Scientific Production.</span> (with Pilatti, G. and Pinheiro, F.)<br>
<span class="meta">2026</span>
<details><summary>Abstract</summary>
<p class="abstract"> </p>
</details>
 ...
 <div class="paper">
<span class="title">Beauty and the Book: Physical Attractiveness and College Major Selection</span> (with Giana Beck and Greg Colman)<br>
<span class="meta">2026</span>
<details><summary>Abstract</summary>
<p class="abstract"> </p>
</details>
...
<div class="paper">
<span class="title">The Age of Invention: Matching Inventor Ages to Patents Based on Web-scraped Sources</span> (with Adam B. Jaffe & Margie Lachman)<br>
<span class="meta">NBER Working Paper No. w28768 · 2021</span>
<details><summary>Abstract</summary>
